...
class DevModeRouterDelegate extends RouterDelegate<LittleLightRoute>
  ...
  MaterialPage loginPage(LittleLightLoginRoute route) =>
      DevModeLoginPage(route.code, route.error);
