...
class DefinitionTableNames {
  static Map<Type, Function> identities = {
    ...
    DestinyMaterialRequirementSetDefinition:
        (json)=>DestinyMaterialRequirementSetDefinition.fromJson(json),
    ...
    DestinyPresentationNodeDefinition:
        (json)=>DestinyPresentationNodeDefinition.fromJson(json),
    ...
    DestinyProgressionLevelRequirementDefinition:
        (json)=>DestinyProgressionLevelRequirementDefinition.fromJson(json),
    ...
    DestinyActivityModifierDefinition:
        (json)=>DestinyActivityModifierDefinition.fromJson(json),
    DestinyReportReasonCategoryDefinition:
        (json)=>DestinyReportReasonCategoryDefinition.fromJson(json),
    ...
    DestinyMilestoneRewardEntryDefinition:
        (json)=>DestinyMilestoneRewardEntryDefinition.fromJson(json)
  };
