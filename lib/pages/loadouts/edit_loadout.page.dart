...
class EditLoadoutPage extends StatefulWidget {
  ...
  EditLoadoutPage({Key key, this.forceCreate = false}) : super(key: key);

  @override
  EditLoadoutPageState createState() => EditLoadoutPageState();
}

class EditLoadoutPageState extends State<EditLoadoutPage> with LanguageConsumer, LoadoutsConsumer, ManifestConsumer {
  bool changed = false;
  ...
  Widget build(BuildContext context) {
    ...
    final creating = true; //(widget.loadout == null || widget.forceCreate);
    return Scaffold(
