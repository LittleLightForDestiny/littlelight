...
class PlatformData {
  ...
  static PlatformData get crossPlayData => PlatformData("Bungie cross save", LittleLightIcons.cross_save, Color.fromARGB(255, 0, 180, 255));
}
