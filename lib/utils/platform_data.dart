  ...
  static PlatformData getPlatform(BungieMembershipType type) {
    switch (type) {
      case BungieMembershipType.TigerXbox:
        return PlatformData("Xbox Live", DestinyIcons.platform_xbox,
            Color.fromARGB(255, 93, 194, 30));

      case BungieMembershipType.TigerPsn:
        return PlatformData("Playstation Network",
            DestinyIcons.platform_playstation, Color.fromARGB(255, 0, 55, 145));

      case BungieMembershipType.TigerBlizzard:
        return PlatformData("Battle.net", DestinyIcons.platform_blizzard,
            Color.fromARGB(255, 0, 180, 255));

      case BungieMembershipType.TigerSteam:
        return PlatformData("Steam", DestinyIcons.platform_steam,
            Color.fromARGB(255, 0, 172, 236));

      case BungieMembershipType.TigerStadia:
        return PlatformData("Stadia", DestinyIcons.platform_stadia,
