...
//   const NestedCollectibleItemWidget({Key? key, required int hash}) : super(key: key, collectibleHash: hash);
...
//     return profile.isCollectibleUnlocked(widget.presentationNodeHash, scope);
//   }
// }
