...
class DetailsItemArmorExoticPerkWidget extends BaseItemSocketsWidget {
  DetailsItemArmorExoticPerkWidget({
    Key key,
...
class DetailsItemArmorExoticPerkWidgetState<T extends DetailsItemArmorExoticPerkWidget>
