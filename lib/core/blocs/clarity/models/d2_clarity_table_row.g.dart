...
ClarityTableRow _$ClarityTableRowFromJson(Map<String, dynamic> json) => ClarityTableRow(
...
Map<String, dynamic> _$ClarityTableRowToJson(ClarityTableRow instance) => <String, dynamic>{
