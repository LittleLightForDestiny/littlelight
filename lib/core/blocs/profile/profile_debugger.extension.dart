...
extension ProfileDebuggerExtension on ProfileBloc {
  Future<void> mockTransfer(DestinyItemInfo itemInfo, int stackSize,
    ...
    if (!hasSpace) {
      throw BungieApiException.fromJson(
          {"ErrorCode": PlatformErrorCodes.DestinyNoRoomInDestination.value});
    }
  }

  Future<bool> hasSpaceFor(
      String? characterId, DestinyItemInfo itemInfo) async {
    ...
    final bucketDef = await manifest
