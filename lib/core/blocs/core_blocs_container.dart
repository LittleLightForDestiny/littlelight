  ...
  CoreBlocsContainer()
      : super(
          providers: [
            ...
            Provider(create: (c) => getInjectedAppConfig()),
            ...
            Provider(create: (c) => getInjectedAuthService().initContext(c)),
            Provider(create: (c) => BungieApiService(c)),
            Provider(create: (c) => getInjectedDestinySettingsService()),
            Provider(create: (c) => LittleLightApiService()),
            ...
            ChangeNotifierProvider<LanguageBloc>(create: (context) => LanguageBloc(context)),
