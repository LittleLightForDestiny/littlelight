...
Loadout _$LoadoutFromJson(Map<String, dynamic> json) => Loadout(
  ...
  equipped: (json['equipped'] as List<dynamic>?)?.map(LoadoutItem.fromJson).toList() ?? const [],
  unequipped: (json['unequipped'] as List<dynamic>?)?.map(LoadoutItem.fromJson).toList() ?? const [],
...
Map<String, dynamic> _$LoadoutItemToJson(LoadoutItem instance) => <String, dynamic>{
  ...
  'socketPlugs': instance.socketPlugs?.map((k, e) => MapEntry(k.toString(), e)),
