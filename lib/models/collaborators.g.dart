...
CollaboratorsResponse _$CollaboratorsResponseFromJson(Map<String, dynamic> json) => CollaboratorsResponse(
  developers: (json['developers'] as List<dynamic>?)?.map(Collaborator.fromJson).toList(),
  designers: (json['designers'] as List<dynamic>?)?.map(Collaborator.fromJson).toList(),
  curators: (json['curators'] as List<dynamic>?)?.map(Collaborator.fromJson).toList(),
  translators: (json['translators'] as List<dynamic>?)?.map(TranslationLanguage.fromJson).toList(),
  supporters: (json['supporters'] as List<dynamic>?)?.map(Collaborator.fromJson).toList(),
);
...
TranslationLanguage _$TranslationLanguageFromJson(Map<String, dynamic> json) => TranslationLanguage(
  languages: (json['languages'] as List<dynamic>).map((e) => e as String).toList(),
  translators: (json['translators'] as List<dynamic>).map(Collaborator.fromJson).toList(),
);
...
Collaborator _$CollaboratorFromJson(Map<String, dynamic> json) => Collaborator(
  ...
  membershipType: $enumDecode(_$BungieMembershipTypeEnumMap, json['membershipType']),
