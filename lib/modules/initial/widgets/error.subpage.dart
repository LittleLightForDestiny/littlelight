...
class StartupErrorSubPageState extends SubpageBaseState<StartupErrorSubPage> with AuthConsumer {
  ...
  Widget get clearAndRestartInstructions => Text(
    "Please try to restart the app, and if that doesn't solve the issue, clear data and restart.".translate(context),
    textAlign: TextAlign.center,
  );
  ...
  Widget get invalidMembershipErrorInstruction => Text(
    "Please make sure you're using the same account you use to play Destiny 2 and the correct platform.".translate(
      context,
    ),
    textAlign: TextAlign.center,
  );
