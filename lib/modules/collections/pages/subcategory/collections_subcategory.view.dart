...
class CollectionsSubcategoryView extends BasePresentationNodeView {
  final CollectionsSubcategoryBloc bloc;
  final CollectionsSubcategoryBloc state;
    ...
    return MultiSectionScrollView(
      [
        SliverSection(
          ...
          itemHeight: 96,
          itemBuilder: (context, index) => buildPresentationNodeItem(context, node.children?.presentationNodes?[index]),
        ),
        SliverSection(
          itemsPerRow: MediaQueryHelper(context).responsiveValue(1, tablet: 2, desktop: 3),
  ...
  Widget buildPresentationNodeItem(BuildContext context, DestinyPresentationNodeChildEntry? presentationNode) {
