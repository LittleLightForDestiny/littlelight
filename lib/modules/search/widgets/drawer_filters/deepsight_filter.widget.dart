...
class DeepsightFilterWidget extends BaseDrawerFilterWidget<DeepsightFilterOptions> {
  @override
  Widget buildTitle(BuildContext context) {
    return Text("Deepsight".translate(context).toUpperCase());
  }

  @override
  Widget buildOptions(BuildContext context, DeepsightFilterOptions data) {
