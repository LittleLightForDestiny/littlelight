...
const weaponIconPresentationNodeHash = 1627803277;
const armorIconPresentationNodeHash = 615947643;
const inventoryIconPresentationNodeHash = 3517356538;
    ...
    switch (index) {
      case 0:
        return ManifestImageWidget<DestinyPresentationNodeDefinition>(
          weaponIconPresentationNodeHash,
          color: getItemForegroundColor(context, index),
        );
      case 1:
        return ManifestImageWidget<DestinyPresentationNodeDefinition>(
          armorIconPresentationNodeHash,
          color: getItemForegroundColor(context, index),
        );
      case 2:
        return ManifestImageWidget<DestinyPresentationNodeDefinition>(
          inventoryIconPresentationNodeHash,
          color: getItemForegroundColor(context, index),
        );
    }
    return Container();
