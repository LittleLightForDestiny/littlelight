...
// import 'package:little_light/modules/triumphs/widgets/collectible_item.widget.dart';
...
//       SizedBox(height: 96, child: CollectibleItemWidget(key: Key("${item.hash}"), collectibleHash: item.hash)),
//     ]);
//   }
