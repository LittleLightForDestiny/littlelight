...
class EditItemTagsView extends StatelessWidget {
  final EditItemTagsBloc bloc;
  final EditItemTagsBloc state;

  const EditItemTagsView({Key? key, required this.bloc, required this.state}) : super(key: key);
