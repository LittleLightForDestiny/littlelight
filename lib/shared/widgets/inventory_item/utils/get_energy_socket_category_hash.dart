...
Future<int?> getEnergySocketCategoryHash(
  ...
  final hardCodedHash =
      hashes.firstWhereOrNull((e) => e == SocketCategoryHashes.energyCapacity);
  ...
  final def = defsList.firstWhereOrNull(
      (def) => def.categoryStyle == DestinySocketCategoryStyle.EnergyMeter);
  return def?.hash;
}
